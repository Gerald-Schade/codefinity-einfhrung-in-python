...
elif product_type == "Perishable" and days_until_expiration >= 4 and days_until_expiration <= 6 and stock_level >= 51:
        print("20% discount applied")
elif product_type == "Perishable" and days_until_expiration >=6 and stock_level <=50:
